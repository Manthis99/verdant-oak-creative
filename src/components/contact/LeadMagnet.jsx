export default function LeadMagnet({ data, onChange, isSubmitting, status }) {
  ...
  return (
    <div className="bg-charcoal border border-gold/30 p-8 md:p-12 rounded-lg contact-reveal relative overflow-hidden">
      ...
      <div className="mb-10 flex items-center justify-between text-xs tracking-widest text-gold uppercase border-b border-gold/20 pb-4 relative z-10">
        <span>Part 3: Final Step</span>
      </div>
      ...
      <div className="space-y-8 relative z-10">
        ...
        >
          <span className="relative z-10 transition-colors duration-500">
            {isSubmitting ? "Sending..." : "Submit & Get the Guide"}
          </span>
