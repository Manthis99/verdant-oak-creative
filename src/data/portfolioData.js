export const portfolioData = [
  {
    ...
    immersiveMeta: [
      { label: "Problem", value: "Explain an economic vision with more clarity and trust." },
      { label: "Audience", value: "Supporters, partners, and future investors." },
      { label: "Role", value: "Messaging direction, filming, and edit." }
    ],
  ...
  },
  {
    ...
    deliverables: ["Brand Messaging & Clarity", "Film & Video Production"],
    immersiveMeta: [
      { label: "Problem", value: "Give the organization one clearer brand explanation." },
      { label: "Audience", value: "Website visitors, donors, and new introductions." },
      { label: "Role", value: "Messaging clarity, story structure, and video production." }
    ],
    immersiveNote: "This kind of brand film matters when the issue is not visibility but language. People need a cleaner way to understand the organization fast.",
    provider: "vimeo",
  ...
  },
  {
    ...
    immersiveMeta: [
      { label: "Problem", value: "Show utility through rhythm and tactile detail." },
      { label: "Audience", value: "Design-conscious product buyers." },
      { label: "Role", value: "Concept, cinematography, and edit." }
    ],
    immersiveNote: "Even in commercial work, the goal is not visual noise. It is to make the product feel useful, desirable, and easy to trust.",
    provider: "youtube",
